        ...
        <div class="col-sm-6">
          <div class="card">
            <div class="card-body">
                <label>Nro: </label>
                <div class="col-sm-6">
                    <input type="text" name="NroSerie" value="${nserie}"class="from-control col-sm-12">
                </div>
            ...
            <div class="card-footer d-flex">
            	<div class="col-sm-6">
            	    <a href="Controlador?menu=NuevaVenta&accion=GenerarVenta" onclick="print()" class="btn btn-success">GenerarVenta</a>
